...
For expected errors, use a `Result<T, TError>` type instead of exceptions. Prefer using CSharpFunctionalExtensions(https://github.com/vkhorikov/CSharpFunctionalExtensions)
